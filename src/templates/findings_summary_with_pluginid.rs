...
/// Port of the Ruby `findings_summary_with_pluginid.rb` template.
pub struct FindingsSummaryWithPluginIdTemplate;

impl Template for FindingsSummaryWithPluginIdTemplate {
    fn name(&self) -> &str {
        "findings_summary_with_pluginid"
    }
